...
export const getActions = (ns, divisionName, cityName) => {
   ...
   **/
  const transfer = async (sourceDivision, sourceCity, targetDivision, targetCity, material, amount) => {
    await rmi(ns)('/bin/corporation/orders/cancel-export-material.js', 1,
      sourceDivision, sourceCity, targetDivision, targetCity, material);
    await rmi(ns)('/bin/corporation/orders/export-material.js', 1,
      sourceDivision, sourceCity, targetDivision, targetCity, material, amount);
  };
